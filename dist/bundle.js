...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  "use strict";
  /* harmony import */
  var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(9);
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_2__components_skillComponent_vue__ = __webpack_require__(30);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_2__components_skillComponent_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_skillComponent_vue__);
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var _content_size = 5;
    var _lock = _content_size;

    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/img/bg.jpg').then(function (res) {
      _lock--;
    ...
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/header.html').then(function (res) {
      ...
      var _scroll_requestframe_id = null;
      ...
      function checkScroll(scroll_pos) {
        ...
        if (scroll_pos < header.clientHeight) {
          ...
          _scroll_requestframe_id = window.requestAnimationFrame(function (_time) {
            ...
            var _scale = Math.min(1.5 * (1 - scroll_pos / header.clientHeight), 1);
    ...
    function initialize_app() {
      ...
      var skillComponent = __WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('skill-component', {
        template: '\
        ...
        methods: {
          getImageSource: function getImageSource(_img) {
            return '/img/icons/' + _img;
          },
          formatRanking: function formatRanking(_ranking_txt) {
            return _ranking_txt.replace(' ', '').replace('Top', 'class').replace('%', '');
          },
          animate: function animate(_duration) {
            ...
            requestAnimationFrame(function animate(time) {
              var timeFraction = (time - start) / _duration;
              if (timeFraction > 1) timeFraction = 1;

              var progress = vm.timingFunction(timeFraction);
          ...
          setAnimations: function setAnimations(_progress) {
            var _score = this.score;
            var _angle = 360 * (_score * (1.05 - Math.abs(_progress - 0.5) / 10) / 5.0);
            if (_angle > 359) _angle = 359;

            this.arc_d = this.describeArc(100, 100, 85, 0, _angle);
          },
          timingFunction: function timingFunction(t) {
            var _ret = (1 - t) * (1 - t) * (1 - t) * Math.sin(t * (this._random + 3));
            return _ret;
          },
      ...
      app = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a({
        el: '#app',
        ...
        methods: {
          ...
          hideResume: function hideResume() {
            console.log('[imadx.github.io] switching to homepage...');
            this.visible_resume = false;
          },
          showHiddenProjects: function showHiddenProjects() {
            this.projects_hidden = false;
          },
          hideHiddenProjects: function hideHiddenProjects(_hidden) {
            if (_hidden) {
              this.projects_hidden = true;
            }
          },
          setDownloaded: function setDownloaded() {
          ...
          getEntity: function getEntity(_url, _local_var) {
            var vm = this;

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(_url).then(function (res) {
          ...
          createArtwork: function createArtwork() {
            var _circles = [];
            var _window_innerWidth = window.innerWidth;
            var _window_innerHeight = window.innerHeight;
          ...
          animateArtwork: function animateArtwork(_time) {

            var _circles = this.artwork_circles;
            var _window_innerWidth = window.innerWidth;
            var _window_innerHeight = window.innerHeight;
            ...
            var _xmouse = this._xmouse || 0;
            var _ymouse = this._ymouse || 0;
            var _xmouse_pos = this._xmouse_pos;
            var _ymouse_pos = this._ymouse_pos;

            var _size = this.artwork_circle_set_size;

            for (var i = 0; i < _size; i++) {

              var _x = _circles[i].x + _circles[i].vx * (i + 1) / _size;
              var _y = _circles[i].y + _circles[i].vy * (i + 1) / _size;
          ...
          isCompactTimeline: function isCompactTimeline() {
            return this.window_width < 980;
          },
          isTooCompactTimeline: function isTooCompactTimeline() {
        ...
        computed: {
          filtered_projects: function filtered_projects() {
            ...
            return _projects.filter(function (_proj) {
              return !_proj.hidden;
            });
          }
        },
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_0__main_js__ = __webpack_require__(8);
...
/***/function (module, exports) {
  ...
  module.exports = { render: function render() {
      ...
      return _c('div', {
        staticClass: "skill-component-div",
        attrs: {
          "title": 'Relative skill measure for ' + _vm.skill + ' as of upwork.com'
        },
        on: {
        ...
        attrs: {
          "src": _vm.getImageSource(_vm.image),
        ...
        staticClass: "score"
      }, [_vm._v(_vm._s(_vm.score)), _c('small', [_vm._v("5.00")])]), _vm._v(" "), _c('span', {
        staticClass: "ranking",
        class: _vm.formatRanking(_vm.ranking),
        attrs: {
          "title": _vm.ranking + ' as of upWork.com'
        }
